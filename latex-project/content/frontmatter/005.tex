...
\tightlist
\item
  将 README 开篇的资料定位调整为``中文学习笔记暨讲义''，并说明个人笔记经修改和补充后已成为可供学习者参考的讲义资料；同时将 README 及免责声明中对整份内容的称呼统一为``本讲义''，将 v2.0 更新说明中的``非主流、学习价值不高''调整为``非主流或学习价值不高''，删除 README 与免责声明中的``图片与OCR说明''章节及 README 关于``（论文）''标题的注意说明，并同步更新 LaTeX 前言。
\item
