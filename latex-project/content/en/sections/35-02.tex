...
\hypertarget{embodied-ai-accelerates-scientific-discovery}{%
\section{Embodied AI Accelerates Scientific Discovery}\label{embodied-ai-accelerates-scientific-discovery}}

\Needspace{5\baselineskip}
\hypertarget{i.-scientific-discovery-with-physical-apis}{%
\subsection{I. Scientific Discovery with Physical APIs}\label{i.-scientific-discovery-with-physical-apis}}
...
\tightlist
\item
  Closing the dry--wet loop of exploratory research, freeing human researchers, and reducing exploration costs
\end{enumerate}
...
\tightlist
\item
  Accelerating nonstandard experiments
\end{enumerate}
...
\tightlist
\item
  Bypassing human-attention bottlenecks to expand parallelism
\end{enumerate}
...
\tightlist
\item
  Improving data quality to simplify reproduction, enable simulation, and increase model accuracy
\end{enumerate}
...
\tightlist
\item
  Capturing scientific discoveries in ``accidents''
\end{enumerate}
...
\Needspace{5\baselineskip}
\hypertarget{ii.-scientific-discovery-through-physical-self-improvement}{%
\subsection{II. Scientific Discovery through Physical Self-Improvement}\label{ii.-scientific-discovery-through-physical-self-improvement}}
...
\tightlist
\item
  Improving experimental operations and equipment
\end{enumerate}
...
\tightlist
\item
  Accelerating idea validation and engineering iteration when exploring new experimental methods and measurement tools
\end{enumerate}
...
\tightlist
\item
  Designing and manufacturing corresponding narrow-domain automation after discovering new experimental pathways
\end{enumerate}
...
\tightlist
\item
  Using intuition accumulated through physical interaction to invent technologies and even propose theories
\end{enumerate}
...
\FloatBarrier
\Needspace{5\baselineskip}
\hypertarget{references-167}{%
\subsection{References}\label{references-167}}
