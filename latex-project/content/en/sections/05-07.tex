...
\hypertarget{zeroth-order-optimization-algorithms}{%
\section{Zeroth-Order Optimization Algorithms}\label{zeroth-order-optimization-algorithms}}

When gradients (first-derivative information) cannot be obtained, zeroth-order optimization can be used.

\Needspace{5\baselineskip}
\hypertarget{i.-genetic-algorithms}{%
\subsection{I. Genetic Algorithms}\label{i.-genetic-algorithms}}
...
\tightlist
\item
  Algorithm workflow (a five-step loop)
\end{enumerate}
...
Crossover: combine parental features to produce offspring, hoping to combine their advantages. Single-point crossover is most common: choose a point randomly, cut both chromosomes there, and exchange their latter halves. (Parent 1: 1010 \textbar{} 1010; parent 2: 1100 \textbar{} 1100; offspring 1: 1010 1100; offspring 2: 1100 1010.)
...
\tightlist
\item
  A simple example: maximizing f(x) = x² on {[}0, 31{]}
\end{enumerate}
...
Parents (B, D): 110 \textbar{} 00 and 100 \textbar{} 11.

Offspring (E, F): 11011 (27) and 10000 (16).

Parents (A, D): 011 \textbar{} 01 and 100 \textbar{} 11.
