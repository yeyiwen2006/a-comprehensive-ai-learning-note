...
\hypertarget{model-memory}{%
\section{Model Memory}\label{model-memory}}

\Needspace{5\baselineskip}
\hypertarget{i.-short-term-memory-context}{%
\subsection{I. Short-Term Memory (Context)}\label{i.-short-term-memory-context}}
...
\item
  Sliding window: retain the most recent K rounds of conversation.
\item
  Summarization: summarize earlier content and ``forget'' the original, usually in conjunction with a sliding window. The summary is temporarily stored in memory and added to the context window of subsequent conversations.
\end{enumerate}

Other methods combining short-term and long-term memory are discussed below.

\Needspace{5\baselineskip}
\hypertarget{ii.-long-term-memory}{%
\subsection{II. Long-Term Memory}\label{ii.-long-term-memory}}
...
\Needspace{5\baselineskip}
\hypertarget{iii.-ram}{%
\subsection{III. RAM}\label{iii.-ram}}
...
\tightlist
\item
  Retaining historical information by importance
\end{enumerate}
...
\tightlist
\item
  The user says, ``My name is Xiaoming.'' \(\to\) store it in context (2 spaces remain).
\item
  The user says, ``The weather is nice today.'' \(\to\) store it in context (1 space remains).
\item
  The user says, ``Have an apple.'' \(\to\) store it in context (full).
\end{enumerate}
...
\item
\Needspace{5\baselineskip}
  \textbf{Operating in the context}:
...
\item
  OpenClaw. (n.d.). \href{https://github.com/openclaw/openclaw}{OpenClaw GitHub repository}. Accessed 2026-09-02.
\item
  thedotmack. (n.d.). \href{https://github.com/thedotmack/claude-mem}{claude-mem GitHub repository}. Accessed 2026-09-02.
\item
  Hugging Face. (n.d.). \href{https://huggingface.co/docs/transformers/main/kv_cache}{Cache strategies}. Transformers Documentation. Accessed 2026-09-02.
\item
