...
\hypertarget{multimodal-large-language-models}{%
\section{Multimodal Large Language Models}\label{multimodal-large-language-models}}

\Needspace{5\baselineskip}
\hypertarget{i.-text-mediated-multimodal-perception}{%
\subsection{I. Text-Mediated Multimodal Perception}\label{i.-text-mediated-multimodal-perception}}

\Needspace{5\baselineskip}
\hypertarget{basic-idea}{%
\subsubsection{1. Basic Idea}\label{basic-idea}}
...
\Needspace{5\baselineskip}
\hypertarget{vision-encoder-clip-as-an-example}{%
\subsubsection{2. Vision Encoder: CLIP as an Example}\label{vision-encoder-clip-as-an-example}}
...
\Needspace{5\baselineskip}
\hypertarget{ii.-native-multimodal-perception}{%
\subsection{II. Native Multimodal Perception}\label{ii.-native-multimodal-perception}}

\Needspace{5\baselineskip}
\hypertarget{basic-idea-1}{%
\subsubsection{1. Basic Idea}\label{basic-idea-1}}
...
\Needspace{5\baselineskip}
\hypertarget{learnable-visual-embedding-layer}{%
\subsubsection{2. Learnable Visual Embedding Layer}\label{learnable-visual-embedding-layer}}
...
\Needspace{5\baselineskip}
\hypertarget{mixed-pretraining}{%
\subsubsection{3. Mixed Pretraining}\label{mixed-pretraining}}
...
\Needspace{5\baselineskip}
\hypertarget{multidimensional-positional-encoding}{%
\subsubsection{4. Multidimensional Positional Encoding}\label{multidimensional-positional-encoding}}
...
\subsubsection{5. Fine-Tuning}\label{fine-tuning}}
...
\Needspace{5\baselineskip}
\hypertarget{iii.-optimizing-image-processing}{%
\subsection{III. Optimizing Image Processing}\label{iii.-optimizing-image-processing}}

\Needspace{5\baselineskip}
\hypertarget{semantically-aligned-complete-encoder-sae-longcat-next}{%
\subsubsection{(1) Semantically Aligned Complete Encoder (SAE) (LongCat-Next)}\label{semantically-aligned-complete-encoder-sae-longcat-next}}

\hypertarget{architecture}{%
\paragraph{1. Architecture}\label{architecture}}
...
\paragraph{2. Loss Functions}\label{loss-functions}}
...
\tightlist
\item
  Independent alignment-training stage
\end{enumerate}
...
\tightlist
\item
  Native multimodal fusion stage
\end{enumerate}
...
\Needspace{5\baselineskip}
\hypertarget{dynamic-resolution-processing}{%
\subsubsection{(2) Dynamic Resolution Processing}\label{dynamic-resolution-processing}}
...
\subsection{References}\label{references-78}}
...
\item
  Dosovitskiy, A., Beyer, L., Kolesnikov, A., et al.~(2021). \href{https://arxiv.org/abs/2010.11929}{An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale}. ICLR 2021.
\item
  He, K., Chen, X., Xie, S., Li, Y., Dollár, P., \& Girshick, R. (2022). \href{https://arxiv.org/abs/2111.06377}{Masked Autoencoders Are Scalable Vision Learners}. CVPR 2022.
\item
