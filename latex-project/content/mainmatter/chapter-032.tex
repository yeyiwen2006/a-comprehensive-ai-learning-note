...
\item
  赋予大模型对世界的``接地''理解、空间认知能力与想象力，在创作、游戏、空间建模、科学发现等领域发挥作用。纵观人类，无论是建筑师设计宏伟的建筑、作家创造天马行空的作品，还是沃森和克拉克发现DNA双螺旋结构、爱因斯坦提出相对论，都离不开这些能力。
\item
  成为具身智能重要的组成部分和训练环境，赋予具身智能在物理世界中行动前规划并预测后果的能力，解决具身智能训练数据不足的难题，对具身智能的发展起着关键的作用。
\item
  部分观点认为是实现AGI必不可少的部分。实现具有人类水平的智能可能需要对物理世界的状态转移规律有着深刻的理解，从而能在物理世界乃至其他复杂环境中进行预测、规划和采取行动（这也和具身有着密切的关系）。
\end{enumerate}
