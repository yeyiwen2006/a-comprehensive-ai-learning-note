...
除了具身行动之外，需要在物理世界推理的场景也需要世界模型如一个能设计新型显微镜的AI，必须理解光与观测对象的相互作用（散射、吸收、荧光、像差）；一个能设计微流控芯片或类器官培养装置的AI，需要对流体力学、扩散、表面张力有内在的模拟能力。这些不是查文献就能解决的，需要AI能根据事物之间相互影响的物理规律，在全新的情境中进行近似的物理模拟。
