...
\hypertarget{ux4e00ux5b9eux73b0ux5168ux6d41ux7a0bux5e72ux6e7fux95edux73afux89e3ux653eux4ebaux7c7bux7814ux7a76ux8005}{%
...
\item
  ...
  具身智能可以7*24小时运行，并显著扩大并行规模（除了一些确实依赖前序实验或受制于资源的实验外），避免人类操作成为时间瓶颈，缩短实验需要的总时间。在单位时间内，获取更多数据意味着能训练更好的模型乃至更好地进行模拟，从而优化得到更优的策略，进一步指导更精准地获取需要的数据，当获取数据效率高的时候这个飞轮就可以跑起来，加速整体发展。
\item
  改进实验操作和设备

  具身智能可以自主改进实验的具体操作，如实时观察微小的形态学变化，结合力学反馈精准控制每个时刻换液的速度、抓取的力度，乃至进行局部微手术等，与实验对象进行自适应交互，大幅减少实验失败重做次数。具身智能还可以改进实验设备，以进一步提高实验的通量和准确性等。
\item
  提高数据质量

  很多实验在不同人做的时候结果相差明显，如平板划线法中每个人划的圈数、方式等不同将直接影响菌落密度。具身智能可实现对软组织、动物、微生物等的操作可溯源、可统一，让湿实验可被复现，减小批次效应的影响，还能收集那些在人类研究中常缺失或被忽略的负样本，为模型的训练提供高质量的数据。
\end{enumerate}
...
\item
  ...
  尽管未来模型可能可以批量提出想法（work和不work的都有），但验证和工程改进会成为瓶颈。硬编码机器人无法处理全新的实验流程，人类迭代速度太慢。具身智能可以在连续的物理探索回路中，以显著超过人类的速度在更大的空间并行试错和迭代改进，极致优化有价值的方法，快速排除效果不佳的方法，技术从想法到在真实实验环境中可用的时间极大缩短、性能显著提高。
\item
  基于物理认知和隐性知识推动发现

  有观点认为，实验技术或测量工具的发明需要对物理规律的深刻理解，以及实验室里那些难以用语言表达、不会写入文献的隐性知识。具身智能既有着对物理世界变化规律和空间结构的认知，又可以在大量实验中积累经验、理解实验的难点和痛点，解决了过去实验科学家和工程师的沟通难题，``知道什么值得做''的创造性科学直觉也可能与浸泡在实验室中的具身经验和隐性知识有关。
\end{enumerate}
...
\hypertarget{ux4e94ux53efux80fdux53efux4ee5ux62bdux8c61ux51faux65b0ux7684ux6982ux5ff5ux63d0ux51faux65b0ux7684ux7406ux8bbaux6846ux67b6}{%
