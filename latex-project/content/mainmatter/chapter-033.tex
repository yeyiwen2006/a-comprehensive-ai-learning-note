...
\hypertarget{ux4e00ux5b9eux73b0ux5168ux6d41ux7a0bux5e72ux6e7fux95edux73af}{%
\subsubsection{（一）实现全流程干湿闭环}\label{ux4e00ux5b9eux73b0ux5168ux6d41ux7a0bux5e72ux6e7fux95edux73af}}

具身智能能像人一样灵活地执行实验，根据样品状态等感知信息实时调整行动；也能积累那些内蕴于``感觉''而不出现在文献中的隐性知识，如怎么构建厚度恰到好处的水膜等。例如细胞多组学数据获取中，当前测序和成像等已自动化，但具身智能还能处理组织解离、单细胞悬液制备、原代细胞处理、iPSC/类器官培养等需根据观测情况实时判断的预处理步骤；基因编辑的核心步骤已自动化，但具身智能还能打通下游克隆扩增、表型确认的链条。此外，软组织切片、动物实验、仪器间衔接、执行新实验流程、故障排错等都将由具身智能完成。具身智能落地后，AI Scientist将从``窄域工业化闭环''走向``通用科学家闭环''。

\hypertarget{ux4e8cux66f4ux5febux5730ux83b7ux53d6ux5927ux91cfux9ad8ux8d28ux91cfux6570ux636e}{%
\subsubsection{（二）更快地获取大量高质量数据}\label{ux4e8cux66f4ux5febux5730ux83b7ux53d6ux5927ux91cfux9ad8ux8d28ux91cfux6570ux636e}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  加速实验进程：具身智能可以7*24小时运行和大规模并行，避免人类操作成为时间瓶颈，缩短实验需要的总时间。
\item
  改进实验操作：具身智能可以自主改进实验的具体操作，如实时观察微小的形态学变化，结合力学反馈精准控制每个时刻换液的速度、抓取的力度，乃至进行局部微手术等，与实验对象进行自适应交互，大幅减少实验失败重做次数。
\item
  提高数据质量：具身智能可实现对软组织、动物等的操作可溯源、可统一，减小批次效应的影响，且能收集那些在人类研究中常缺失或被忽略的负样本，为模型的训练提供高质量的数据。
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  加快想法验证和迭代改进的速度：尽管模型可能可以批量提出想法（work和不work的都有），但验证和工程改进会成为瓶颈。硬编码机器人无法处理，人类迭代速度太慢。具身智能可以在连续的物理探索回路中，以显著超过人类的速度在更大的空间并行试错和迭代改进，极致优化有价值的方法，快速排除效果不佳的方法，技术从想法到在真实实验环境中可用的时间极大缩短、性能显著提高。
\item
  基于物理认知和隐性知识推动发现：实验技术或测量工具的发明需要对物理规律的深刻理解，以及实验室里那些难以用语言表达、不会写入文献的隐性知识。具身智能既有着对物理世界变化规律和空间结构的认知，又可以在大量实验中积累经验、理解实验的难点和痛点，解决了过去实验科学家和工程师的沟通难题，``知道什么值得做''的创造性科学直觉也可能与浸泡在实验室中的具身经验和隐性知识有关。
\end{enumerate}

\hypertarget{ux56dbux6355ux6349ux610fux5916ux4e2dux7684ux79d1ux5b66ux53d1ux73b0}{%
\subsubsection{（四）捕捉``意外''中的科学发现}\label{ux56dbux6355ux6349ux610fux5916ux4e2dux7684ux79d1ux5b66ux53d1ux73b0}}
...
\hypertarget{ux4e00ux4ee5ux884cux52a8ux4fc3ux8fdbux611fux77e5}{%
\subsubsection{（一）以行动促进感知}\label{ux4e00ux4ee5ux884cux52a8ux4fc3ux8fdbux611fux77e5}}

某种意义上，具备具身行动能力的系统可能才真正具有人类水平的感知能力。

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  行动是对感知的真正检验：多模态LLM虽然具备一定的视觉感知能力，但单纯加入多模态推理数据对增强模型的视觉推理能力效果不显著。根本原因在于，语言往往是对视觉状态的概括性描述，如果视觉推理最终以语言为导向，就不可避免地在感知中偏重高层语义而忽略很多底层细节，这和VLA模型在泛化性上遇到的障碍本质上是同源的。人类的感知能力来源于对在物理世界中行动的需要，能在物理世界行动才是对感知能力的真正检验。因此，对具身行动能力的训练，也将促进模型感知能力的提升。
\item
  行动范围的扩大带来感知范围的扩大：从本质上说，随着智能的发展，其行动范围将不断扩大。对于具身智能而言，行动范围决定了模型能从什么样的环境采集什么样的数据，这又决定了模型的感知范围。行动范围越广，可以感知的范围和获得信息的分布也就越广，这将促进智能水平的提升。后文会提到具身智能还可能改进自身的感知模块，这也是行动范围扩大带来感知范围扩大的一种表现。
\end{enumerate}

\hypertarget{ux4e8cux7a81ux7834ux6570ux636eux5c40ux9650ux5b9eux73b0ux81eaux4e3bux5b66ux4e60}{%
\subsubsection{（二）突破数据局限，实现自主学习}\label{ux4e8cux7a81ux7834ux6570ux636eux5c40ux9650ux5b9eux73b0ux81eaux4e3bux5b66ux4e60}}
...
\hypertarget{ux4e09ux5b9eux73b0ux81eaux6211ux6539ux8fdb}{%
\subsubsection{（三）实现自我改进}\label{ux4e09ux5b9eux73b0ux81eaux6211ux6539ux8fdb}}
...
\hypertarget{ux56dbux5c06ux611fux77e5ux63a8ux7406ux884cux52a8ux95edux73afux6269ux5c55ux5230ux66f4ux591aux573aux666f}{%
\subsubsection{（四）将``感知---推理---行动''闭环扩展到更多场景}\label{ux56dbux5c06ux611fux77e5ux63a8ux7406ux884cux52a8ux95edux73afux6269ux5c55ux5230ux66f4ux591aux573aux666f}}
