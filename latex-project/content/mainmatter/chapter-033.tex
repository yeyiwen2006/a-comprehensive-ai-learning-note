...
\item
  提高数据质量：具身智能可实现对软组织、动物等的操作可溯源、可统一，让湿实验可被复现，减小批次效应的影响，还能收集那些在人类研究中常缺失或被忽略的负样本，为模型的训练提供高质量的数据。
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  加快想法验证和迭代改进的速度：尽管未来模型可能可以批量提出想法（work和不work的都有），但验证和工程改进会成为瓶颈。硬编码机器人无法处理全新的实验流程，人类迭代速度太慢。具身智能可以在连续的物理探索回路中，以显著超过人类的速度在更大的空间并行试错和迭代改进，极致优化有价值的方法，快速排除效果不佳的方法，技术从想法到在真实实验环境中可用的时间极大缩短、性能显著提高。
\item
...
\hypertarget{ux4e09ux5b9eux73b0ux81eaux6211ux6539ux8fdbux6269ux5c55ux5e94ux7528ux573aux666f}{%
\subsubsection{（三）实现自我改进，扩展应用场景}\label{ux4e09ux5b9eux73b0ux81eaux6211ux6539ux8fdbux6269ux5c55ux5e94ux7528ux573aux666f}}
