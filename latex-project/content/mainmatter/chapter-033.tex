...
=
\mathbb{E}_{y,\varepsilon,t}
\left[
\left\|
f_\theta(y_t,t,o,l)-(\varepsilon-y)
\right\|_2^2
\right].
\]
...
\tightlist
\item
  Zhang, Q., Li, L., Zhang, L., et al.~(2026). \href{https://arxiv.org/abs/2607.08639}{Native Video-Action Pretraining for Generalizable Robot Control}. arXiv:2607.08639.
\item
...
\item
  Song, Z., Li, Q., Qin, S., et al.~(2026). \href{https://arxiv.org/abs/2603.00110}{Learning Physics from Pretrained Video Models: A Multimodal Continuous and Sequential World Interaction Model for Robotic Manipulation}. arXiv:2603.00110.
\end{itemize}
