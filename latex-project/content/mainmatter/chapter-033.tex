...
自然科学的进步常依赖于实验技术或测量工具方面的创新，它们将带来大量高质量的数据，具身智能的作用在这里不可或缺。一方面，实验技术或测量工具需要在真实实验中验证和改进，硬编码机器人无法处理，而具身智能可以在连续的物理探索回路中，以显著超过人类的速度在更大的空间并行试错和迭代，极致优化有价值的方法，快速排除效果不佳的方法，从而在想法能批量产生时，让验证不再是瓶颈，技术从想法到在真实实验环境中可用的时间极大缩短、性能显著提高；另一方面，实验技术的发明需要实验经验和那些难以用语言表达的隐性知识，具身智能可以在大量实验中积累经验和隐性知识，理解实验过程的难点和痛点，解决了过去实验科学家和工程师的沟通难题，``知道什么值得做''的创造性科学直觉也可能与浸泡在实验室中的具身经验和隐性知识有关。
...
此外，机器人还可以参与自主设计、优化和制造下一代机器人，实现``Robots for Robots''。具身智能可以通过模型训练、结构设计、仿真测试、结构优化、零部件制造，以及真实场景下的试验与迭代等，实现自我改进。具身智能还可以通过改进传感器等方式，拓宽自身从环境获取数据的渠道，这一点和前面提到的发明实验技术或测量工具本质上是相似的。
