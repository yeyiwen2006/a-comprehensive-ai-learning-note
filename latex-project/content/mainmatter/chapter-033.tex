...
\section{具身智能的展望}\label{ux5177ux8eabux667aux80fdux7684ux5c55ux671b}}

大语言模型诞生后，AI在数字世界快速发展；具身智能则意味着AI向物理世界拓展，打通现实世界中感知、推理与行动的闭环，带来智能形态的重要变革。下面是对未来具身智能发展的一些展望。

\hypertarget{ux4e00ux5177ux8eabux667aux80fdux7684ux57faux672cux5f62ux6001ux4e0eux5e94ux7528}{%
\subsection{一、具身智能的基本形态与应用}\label{ux4e00ux5177ux8eabux667aux80fdux7684ux57faux672cux5f62ux6001ux4e0eux5e94ux7528}}
...
\hypertarget{ux4e8cux5177ux8eabux667aux80fdux52a0ux901fux79d1ux5b66ux53d1ux73b0}{%
\subsection{二、具身智能加速科学发现}\label{ux4e8cux5177ux8eabux667aux80fdux52a0ux901fux79d1ux5b66ux53d1ux73b0}}

对于自然科学和医学等领域，AI for Science的核心瓶颈在于数据与实验验证。当有潜力的方法和想法可以被大量提出，实验验证就成为了瓶颈；即便可以通过构建模拟来减少对湿实验的需求，构建模拟的难点依然不在于模型，而在于大量、高质量、可复现的扰动数据。只有具身智能才能自主地进行实验验证和获取数据。而对于理论物理学等领域，那些伟大的``概念跃迁''和全新框架的发明意味着在人类已有概念框架内插值的大语言模型不足以解决问题，而是需要能与真实世界持续互动的智能。

\hypertarget{ux4e00ux5b9eux73b0ux63a2ux7d22ux6027ux7814ux7a76ux7684ux5e72ux6e7fux95edux73afux89e3ux653eux4ebaux7c7bux7814ux7a76ux8005ux964dux4f4eux63a2ux7d22ux6210ux672c}{%
\subsubsection{（一）实现探索性研究的干湿闭环，解放人类研究者，降低探索成本}\label{ux4e00ux5b9eux73b0ux63a2ux7d22ux6027ux7814ux7a76ux7684ux5e72ux6e7fux95edux73afux89e3ux653eux4ebaux7c7bux7814ux7a76ux8005ux964dux4f4eux63a2ux7d22ux6210ux672c}}
...
\hypertarget{ux4e8cux66f4ux5febux5730ux83b7ux53d6ux5927ux91cfux9ad8ux8d28ux91cfux53efux590dux73b0ux6570ux636eux7528ux4e8eux8badux7ec3ux6a21ux578bux7b49}{%
\subsubsection{（二）更快地获取大量高质量、可复现数据，用于训练模型等}\label{ux4e8cux66f4ux5febux5730ux83b7ux53d6ux5927ux91cfux9ad8ux8d28ux91cfux53efux590dux73b0ux6570ux636eux7528ux4e8eux8badux7ec3ux6a21ux578bux7b49}}
...
\hypertarget{ux4e09ux63a8ux52a8ux5b9eux9a8cux6280ux672fux6216ux6d4bux91cfux5de5ux5177ux7684ux521bux65b0}{%
\subsubsection{（三）推动实验技术或测量工具的创新}\label{ux4e09ux63a8ux52a8ux5b9eux9a8cux6280ux672fux6216ux6d4bux91cfux5de5ux5177ux7684ux521bux65b0}}
...
\item
  ...
  具身智能可以自主改进实验的具体操作，如实时观察微小的形态学变化，结合力学反馈精准控制每个时刻换液的速度、抓取的力度，乃至进行局部微手术等，与实验对象进行自适应交互，大幅减少实验失败重做次数。具身智能还可以改进实验设备，设计更高效率的设备，提高实验的通量和准确性等。
\item
  在探索回路中，加快想法验证和工程迭代改进的速度

  尽管未来模型可能可以批量提出想法（work和不work的都有），但验证和工程改进会成为瓶颈，无法构成闭环。具身智能可以以显著超过人类的速度在更大的空间并行试错和迭代改进，处理硬编码机器人无法处理的实验流程，优化有价值的方法，快速排除效果不佳的方法，技术从想法到在真实实验环境中可用的时间极大缩短、性能显著提高。
\item
  基于隐性知识推动新技术或新工具的发明

  具身智能既有着对物理世界变化规律和空间结构的认知，又可以在大量实验中积累经验，理解实验的难点和不会写入文献的隐性知识，解决了实验科学家和工程师的沟通难题，``知道什么值得做''的创造性科学直觉也可能与浸泡在实验室中的具身经验和隐性知识有关。
\end{enumerate}

\hypertarget{ux56dbux5e2eux52a9ux63d0ux51faux5168ux65b0ux7684ux79d1ux5b66ux53d1ux73b0}{%
\subsubsection{（四）帮助提出全新的科学发现}\label{ux56dbux5e2eux52a9ux63d0ux51faux5168ux65b0ux7684ux79d1ux5b66ux53d1ux73b0}}
...
\item
  可能可以抽象出新的概念，提出新的理论框架

  牛顿将世界万物复杂的相互作用抽象为统一的``力''，爱因斯坦在对物理世界场景的思想实验中提出相对论。大语言模型无法实现这一点，因为它们对世界的认知来源于预训练数据，只能在已有数据包含的概念和框架中插值组合，这并不会得到全新的概念或理论。而强化学习也不会让模型具备概念层次的创新能力。人类在与物理世界的反复直接交互中，才从原始数据里抽象出了力、因果性等概念，发明经典力学、相对论、量子力学等新颖的概念框架。具身智能可以与现实世界主动交互，自主从物理世界获得已有框架之外的信息，这可能是实现概念级创新的必要条件。
\end{enumerate}
...
\hypertarget{ux4e00ux5b9eux73b0ux5bf9ux7269ux7406ux4e16ux754cux7684ux771fux6b63ux7406ux89e3}{%
\subsubsection{（一）实现对物理世界的真正理解}\label{ux4e00ux5b9eux73b0ux5bf9ux7269ux7406ux4e16ux754cux7684ux771fux6b63ux7406ux89e3}}

某种意义上，具备具身行动能力的智能才是在对物理世界的理解上达到人类水平的智能。多模态LLM虽然具备一定的视觉感知能力，但单纯加入多模态推理数据对增强模型的视觉推理能力效果不显著。根本原因在于，语言往往是对视觉状态的概括性描述，如果视觉推理最终以语言为导向，就不可避免地偏重高层语义而忽略很多底层细节，而这些细节往往蕴含着对物理世界规律的理解，这和VLA模型在泛化性上遇到的障碍本质上是同源的。人类的感知和对物理世界的理解能力来源于对在物理世界中行动的需要，能在物理世界行动才是对物理推理能力的真正检验。以具身行动能力为目标训练模型，也将促进模型对物理世界理解能力的提升。未来，若将这种对物理世界的深刻理解与大语言模型的逻辑推理融合，可能将解锁全新的能力，将智能水平提升到新的高度。

\hypertarget{ux4e8cux63a8ux52a8ux5404ux7c7bux8981ux7d20ux6269ux5c55ux5b9eux73b0ux81eaux4e3bux5b66ux4e60}{%
\subsubsection{（二）推动各类要素扩展，实现自主学习}\label{ux4e8cux63a8ux52a8ux5404ux7c7bux8981ux7d20ux6269ux5c55ux5b9eux73b0ux81eaux4e3bux5b66ux4e60}}
...
\item
  ...
  人类互联网的数据在规模、模态、内容范围上都是受限的，依赖人类把数据放进电脑里、``喂''给模型可能终究是不可持续的。当具身智能达到可以自主与环境互动的水平，就可以与现实世界交互，在交互中主动获取所需要的各种类型的环境数据（如在日常生活环境中主要是视觉、听觉、触觉和传感器数据等）以及验证自己的判断，理论上这样可以获得可无限扩展的数据。随着具身智能的发展，其行动范围将不断扩大，可获得数据的分布的广度也不断增大，且模型可以主动行动以获取自己缺失的数据，这是自主学习的重要一环。
\item
  扩展验证范围，构成物理世界中的优化闭环

  LLM在数学、代码和Agent任务上的提升主要依赖于基于可验证奖励的强化学习。具身智能正可以将可验证的范围拓宽到现实世界，从而让需要与现实世界交互的任务也可以构成可被模型处理的闭环，从而可以进行``信用分配''和优化。
\item
  实现自主学习的闭环

  自主学习即智能体主动在与环境的交互中获取数据和反馈，并以此主动更新自身认知。在具身智能或未来与大模型融合形成的下一代模型中，前者不仅包括用于深度学习的环境状态转移、动作等数据，还可以包括用于强化学习的奖励信号；后者未来则可以结合利用给定数据或奖励优化模型的方法（如AI for AI等）。二者可以实现自主学习的闭环，这也正好和《The Bitter Lesson》中提到的搜索与学习呼应。未来，对于具备具身能力的基础模型，或许我们可以在训练阶段用类似于RL的方法（如在需要探索环境的任务上训练）或其他方法训练出推理时可以在新环境中主动学习并快速适应，进而在其中出色地执行新任务的模型。
\item
...
\hypertarget{ux4e09ux5b9eux73b0ux7269ux7406ux4e16ux754cux667aux80fdux7684ux81eaux6211ux6539ux8fdb}{%
\subsubsection{（三）实现物理世界智能的自我改进}\label{ux4e09ux5b9eux73b0ux7269ux7406ux4e16ux754cux667aux80fdux7684ux81eaux6211ux6539ux8fdb}}
...
\item
  ...
  LLM已经呈现出参与自我改进的迹象，如模型训练和智能体框架等方面，但其互动环境限于计算机内部。具身智能的自我改进则更加广泛，包括模型训练、物理结构设计、生产制造、测试与迭代等。具身智能不仅可以自主获取数据，还可以通过改进传感器和行动模块等方式，拓宽自身从环境获取数据、与环境交互的渠道，扩大感知和行动的空间。从这个角度看，前面提到的发明实验技术或测量工具，本质上也可以视为具身智能自我改进的一环。
\item
  将智能扩展到更多新环境
...
\item
  Sutton, R. S. (2019). \href{http://www.incompleteideas.net/IncIdeas/BitterLesson.html}{The Bitter Lesson}.
\item
...
\item
  Physical Intelligence, Black, K., Brown, N., Darpinian, J., et al.~(2025). \href{https://arxiv.org/abs/2504.16054}{π0.5: A Vision-Language-Action Model with Open-World Generalization}. arXiv:2504.16054.
\item
  Liu, Z., Liu, J., Chen, H., et al.~(2026). \href{https://arxiv.org/abs/2601.05248}{LaST0: Latent Spatio-Temporal Chain-of-Thought for Robotic Vision-Language-Action Model}. arXiv:2601.05248.
\item
