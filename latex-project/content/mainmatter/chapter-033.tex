...
自然科学的进步常依赖于实验技术或测量工具方面的创新，它们将带来大量高质量的数据，具身智能的作用在这里不可或缺。一方面，实验技术或测量工具需要在真实实验中验证和改进，具身智能可以在连续的物理探索回路中，以远超人类的速度大规模并行试错和迭代（测量工具试验的反馈速度快于大多湿实验），在大得多的物理参数空间自主搜索和极致优化，使技术从想法到在真实实验环境中可用的时间极大缩短、性能显著提高；另一方面，实验技术的发明需要实验经验和那些难以用语言表达的隐性知识，具身智能可以在大量实验中积累经验和隐性知识，理解实验过程的难点和痛点，解决了过去实验科学家和工程师的沟通难题，``知道什么值得做''的创造性科学直觉也可能与浸泡在实验室中的具身经验和隐性知识有关。
