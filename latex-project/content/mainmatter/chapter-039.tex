...
+ \lambda_1 \mathcal{L}_{\mathrm{latent}}(\theta)
+ \lambda_2 \mathcal{L}_{\mathrm{value}}(\theta)
+ \lambda_3 \mathcal{L}_{\mathrm{end}}(\theta)
\]
...
\min\left(
r_t^k(\theta)\hat{A}_t,\,
\operatorname{clip}\left(r_t^k(\theta), 1-\epsilon_{\min}, 1+\epsilon_{\max}\right)\hat{A}_t
\right)
\right]
\]
