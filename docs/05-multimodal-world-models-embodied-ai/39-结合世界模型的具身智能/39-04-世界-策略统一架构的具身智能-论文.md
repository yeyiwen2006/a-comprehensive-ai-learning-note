...
source_docx: "第5部分 多模态生成、世界模型与具身智能/39.结合世界模型的具身智能/39.4 世界-策略统一架构的具身智能（论文）.docx"
...
## 三、Pelican-Unified 1.0：将预测与动作在 Diffusion 中共同解码
...
![PhysGen 物理 token 自回归示意图](../../../assets/images/05-multimodal-world-models-embodied-ai/39-结合世界模型的具身智能/img-4c69b72c0632-0025.png)
...
## 五、LaST-R1：对“世界隐状态推理-动作生成”思维链运用RL
...
- Zhang, Y., Chen, Y., Liu, C., Ding, Z., Xu, J., Zou, S., et al. (2026). [Pelican-Unified 1.0: A Unified Embodied Intelligence Model for Understanding, Reasoning, Imagination and Action](https://arxiv.org/abs/2605.15153). arXiv:2605.15153.
