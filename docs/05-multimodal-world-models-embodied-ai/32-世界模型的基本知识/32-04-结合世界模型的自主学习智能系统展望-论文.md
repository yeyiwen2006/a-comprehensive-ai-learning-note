...
source_docx: "第5部分 多模态生成、世界模型与具身智能/32.世界模型的基本知识/32.4 结合世界模型的自主学习智能系统展望（论文）.docx"
...
![A-B-M 自主学习架构示意图](../../../assets/images/05-multimodal-world-models-embodied-ai/32-04/abm-autonomous-learning-architecture.png)
...
![System A 与 System B 交互示意图](../../../assets/images/05-multimodal-world-models-embodied-ai/32-04/system-a-b-interaction.png)
