---
title: "34.7 视频生成模型与生成式世界模型的表征学习和Tokenizer（论文）"
source_docx: "第5部分 多模态生成、世界模型与具身智能/34.多模态生成与生成式世界模型/34.7 视频生成模型与生成式世界模型的表征学习和Tokenizer（论文）.docx"
...
# 34.7 视频生成模型与生成式世界模型的表征学习和Tokenizer（论文）
