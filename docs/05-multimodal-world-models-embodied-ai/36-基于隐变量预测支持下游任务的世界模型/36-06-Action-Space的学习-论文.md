...
source_docx: "第5部分 多模态生成、世界模型与具身智能/36.基于隐变量预测支持下游任务的世界模型/36.6 Action Space的学习（论文）.docx"
...
![DiLA 动作空间学习模型架构](../../../assets/images/05-multimodal-world-models-embodied-ai/36-基于隐变量预测支持下游任务的世界模型/36-06-dila-architecture.png)
