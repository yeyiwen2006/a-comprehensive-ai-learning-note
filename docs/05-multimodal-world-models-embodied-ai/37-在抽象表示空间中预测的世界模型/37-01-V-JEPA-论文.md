...
source_docx: "第5部分 多模态生成、世界模型与具身智能/37.在抽象表示空间中预测的世界模型/37.1 V-JEPA（论文）.docx"
...
1. 用 $L_1$ 范数是因为受极端值影响小，实验发现更稳定。其仅在 $0$ 处不可导（类似 ReLU）。

2. 由于没有重建损失，为了防止“模式崩塌”，$y$ 的 encoder 更新方法类似于强化学习的“目标网络”，即从 $x$ 的 encoder 网络软更新：
