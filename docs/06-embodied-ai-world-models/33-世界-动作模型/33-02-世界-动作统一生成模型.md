...
- 视觉观察序列：$\{O_0,O_1,O_2,\ldots,O_{N-1}\}$，从0开始，共 $N$ 个初始帧。
- 对应动作序列：$\{A_1,A_2,\ldots,A_{N-1}\}$，从1开始，共 $N-1$ 个初始动作。
...
- Zhang, Q., Li, L., Zhang, L., et al. (2026). [Native Video-Action Pretraining for Generalizable Robot Control](https://arxiv.org/abs/2607.08639). arXiv:2607.08639.
...
- Song, Z., Li, Q., Qin, S., et al. (2026). [Learning Physics from Pretrained Video Models: A Multimodal Continuous and Sequential World Interaction Model for Robotic Manipulation](https://arxiv.org/abs/2603.00110). arXiv:2603.00110.
