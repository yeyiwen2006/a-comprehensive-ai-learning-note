---
title: "33.4 VLA模型"
source_docx: "第5部分 世界模型、多模态生成与具身智能/33.具身智能的基本知识/33.4 VLA模型.docx"
...
$$
\mathcal{J}(\theta)=\mathbb{E}_{(o,l,a)\sim\mathcal{D}}\left[\sum_{k=1}^{K}\log P_{\theta}(z_k\mid z_{<k},o_{\le t},l)\right]
$$
...
$$
\mathcal{L}_{\mathrm{FM}}(\theta)=\mathbb{E}_{t\sim U(0,1),x_0\sim p_0,x_1\sim p_1}\left[\left\|v_\theta(x_t,t,c)-(x_1-x_0)\right\|^2\right]
$$
...
$$
\|o_{t+1}-\hat{o}_{t+1}\|^2+\|\mathrm{sg}[\mathrm{Encoder}(o_t,o_{t+1})]-e_{z_t}\|^2+\beta\|\mathrm{Encoder}(o_t,o_{t+1})-\mathrm{sg}[e_{z_t}]\|^2
$$
...
$$
\mathcal{L}_{\mathrm{Action}}=\mathbb{E}\left[-\log P_\phi(a_t\mid z_t,o_t,\mathrm{embodiment\_id})\right]
$$
