...
MCP HOSt Application (e.g.. Claude Desktop) MCP Server (e.g.. LocaI Script, CIoud Service) Request User Final Response LLM (Large Language Model To 引 Call lnstruction MCP CI ient Context with Data MCP ProtocOl (JSON-RPC 2 ． 0） T00 | Result / Data TOOls 0 Resources Prompts External Resources (e.g., Database. API, Filesystem)
