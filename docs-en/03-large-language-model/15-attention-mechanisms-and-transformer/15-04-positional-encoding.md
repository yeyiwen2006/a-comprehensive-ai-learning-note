...
## I. Sinusoidal Positional Encoding in the Classic Transformer
...
(1) Boundedness: every dimension of the positional-encoding vector stays within $[-1,1]$, preventing it from overwhelming the semantic information.

(2) Adaptability to sequences of different lengths:
...
(3) Positional additivity: from the trigonometric identities
...
2. Why is positional encoding a $d_{model}$-dimensional vector with a different value for each feature dimension $i$?
...
3. Why must wavelengths grow exponentially as $10000^{2i/d}$ rather than linearly?
...
## II. Rotary Position Embedding (RoPE)
